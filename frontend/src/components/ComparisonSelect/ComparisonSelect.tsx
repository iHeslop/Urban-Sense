...
const ComparisonSelect = ({handleComparisonChange, comparison}: ComparisonSelectProps) => {
    return (
        <>
            <select value={comparison} onChange={(e) => handleComparisonChange(e.target.value)}>
